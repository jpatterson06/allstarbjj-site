...
export const towns: Town[] = [
...

  {
    ...
    whyDriveHere: "Summit families who search for BJJ will find Vitor Shaolin's website ranking for Summit — but his school is in Scotch Plains, the same drive from Summit that we are from Union. What Shaolin doesn't have is Renzo Gracie lineage. Coach Jamal trained directly under Renzo in New York — the most respected name in BJJ globally — and competed at ADCC, the highest-level grappling event in the world. The question isn't who ranks first on Google. It's which coach has the credentials to back it up.",
