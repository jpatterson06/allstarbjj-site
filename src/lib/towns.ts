...
export const towns: Town[] = [
  ...
  },
  {
    ...
    whyDriveHere: "There are solid martial arts options around Cranford — some even share our lineage. What sets AllStar apart is the coach. Jamal Patterson isn't just a black belt — he's a 4th degree black belt under Renzo Gracie, an ADCC veteran, a pro MMA fighter with wins in the IFL and Bellator, and a UWC Light Heavyweight Champion. That competition experience changes how technique is taught. Cranford families who've been with us for five and ten years will tell you the difference shows up on the mat.",
  ...
  },
  {
    ...
    whyDriveHere: "Maplewood has closer options, including No-Gi-only schools right in the village. AllStar is fifteen minutes down Springfield Ave and offers Gi + No-Gi BJJ, Muay Thai, and MMA under a 4th degree Renzo Gracie black belt with an ADCC and pro MMA record. SOMA parents who do the homework — who look at lineage, full program, and long-term development — consistently land here.",
  ...
  },
  {
    ...
    whyDriveHere: "The martial arts options closest to Chatham are mostly schools where BJJ was added on as an extra class. That's not the same as a school built around BJJ from day one with Renzo Gracie lineage behind it. Chatham Borough families are tight-knit and do their research — word travels fast when a school is the real thing. Coach Jamal is a 4th degree black belt under Renzo Gracie and an ADCC veteran. That's not marketing language. That's a verifiable competition record.",
  ...
  },
  {
    ...
    whyDriveHere: "Livingston has martial arts options right in town. If all you want is something local, that works. But if you want Renzo Gracie lineage, an ADCC-level competitor coaching your kid, and a school that has been built around BJJ since 2011 — that's AllStar, 18 minutes away. Livingston parents with high standards who have done the comparison keep ending up here. The credentials aren't close.",
  ...
  },
  {
    ...
    hookLine: "Eight minutes from Kenilworth. The hardest part is deciding which class to start with.",
    whyDriveHere: "Kenilworth families know what it means to get serious about their kids' development. If you're looking for real BJJ — not the strip-mall kind — AllStar is eight minutes north via Boulevard. Coach Jamal has been building this school since 2011 under Renzo Gracie lineage, and the lineage matters. Kenilworth parents who've been with us year after year will tell you: the difference between real instruction and everything else shows up fast. By month two, your kid is different.",
    adultAngle: "Kenilworth working adults train at AllStar for the same reason everyone else does: it actually works. You get stronger, calmer, more capable. The evening classes fit around a 9-to-5. Eight minutes north and you're on the mat. Two weeks free — no reason to guess when you can test it.",
